...
module.exports = NodeHelper.create({
    ...
    var quranArabicURL = "https://api.alquran.cloud/v1/ayah/262" + randomAyah + "/editions/ar";
    var quranTranslationURL = "https://api.alquran.cloud/v1/ayah/262" + randomAyah + "/editions/" + payload.translationLang;
